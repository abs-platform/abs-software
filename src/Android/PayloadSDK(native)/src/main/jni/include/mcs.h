...
MCSPacket *mcs_ok_packet_data(unsigned int id, void *data, size_t size);
MCSPacket *mcs_ok_packet(unsigned int id);
MCSPacket *mcs_err_packet(unsigned int id, int err_code);
